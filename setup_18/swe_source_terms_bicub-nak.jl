###################################################################################################
# Identical to Trixi.jl's examples/tree_2d_dgsem/elixir_shallowwater_source_terms.jl just that    #
# the bottom topography function is approximated by bicubic B-splines with not-a-knot end         #
# condition.                                                                                      #
###################################################################################################
...
# This variable has to be adjusted to receive the other results
n = 4
...
spline           = BicubicBSpline(interp_x, interp_y, interp_z; end_condition = "not-a-knot")
