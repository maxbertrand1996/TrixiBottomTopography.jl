###################################################################################################
# This script is used to verify that the well-balanced property is fulfilled when using bilinear  #
# B-spline interpolation over a data set which contains 625 data points                           #
###################################################################################################
...
spline_struct = BilinearBSpline(Rhine_data)
