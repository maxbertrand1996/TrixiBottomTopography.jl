...
# B-spline interpolation with not-a-knot end condition over a data set which contains 625 data    #
# points                                                                                          #
###################################################################################################
...
spline_struct = BicubicBSpline(Rhine_data; end_condition = "not-a-knot")
