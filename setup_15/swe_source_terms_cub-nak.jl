###################################################################################################
# Identical to Trixi.jl's examples/tree_1d_dgsem/elixir_shallowwater_source_terms.jl just that    #
# the bottom topography function is approximated by cubic B-splines with not-a-knot end condition #
###################################################################################################
...
spline         = CubicBSpline(interp_x, interp_y; end_condition="not-a-knot")
