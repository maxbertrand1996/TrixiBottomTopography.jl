###################################################################################################
# This script is used to verify that the well-balanced property is fulfilled when using linear    #
# B-spline interpolation over a data set which contains 25 data points                            #
###################################################################################################
...
spline_struct = LinearBSpline(Rhine_data)
