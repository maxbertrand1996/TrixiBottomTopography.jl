...
# condition implemented in TrixiBottomTopography.jl                                               #
###################################################################################################
...
bicub_struct = BicubicBSpline(Rhine_data)
...
plot(x_int_pts, y_int_pts, z_int_pts, st =:surface, camera=(-30,30),
     ...
     label="Bottom topography", title="Bicubic B-spline interpolation with free end condition")